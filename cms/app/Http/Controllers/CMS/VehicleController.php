...
class VehicleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $vehicle->car_type_Economy   =   $request->car_type_Economy;
        $vehicle->car_type_SUV   =   $request->car_type_SUV;
        $vehicle->car_type_Hatchback   =   $request->car_type_Hatchback;
        $vehicle->car_type_Luxury   =   $request->car_type_Luxury;
