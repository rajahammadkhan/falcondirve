                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="by" value="Falcon Drive"
                                            class="form-control" placeholder="By..." readonly="true" required>
                                        @if ($errors->has('by'))
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea rows="4" name="short_description" class="form-control" required>{{ $blog->short_description ?? old('short_description') ?? null }}</textarea>
