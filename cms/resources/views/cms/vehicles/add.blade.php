                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <!-- <select class="basic" name="car_type" required>
                                            <option selected disabled>Please Select</option>
                                                <option {{$isEdit && $vehicle->car_type == 'Economy' ? 'selected' : null}} value="Economy">Economy</option>
                                                <option {{$isEdit && $vehicle->car_type == 'SUV' ? 'selected' : null}} value="SUV">SUV</option>
                                                <option {{$isEdit && $vehicle->car_type == 'Hatchback' ? 'selected' : null}} value="Hatchback">Hatchback</option>
                                        </select> -->
                                            <br>
                                            <label for="Economy">
                                                <input type="checkbox" name="car_type_Economy" id="Economy" value="Economy" {{ $vehicle->car_type_Economy === 'Economy' ? 'checked' : '' }}> Economy
                                            </label>

                                            <label for="SUV">
                                                <input type="checkbox" name="car_type_SUV" id="SUV" value="SUV" {{ $vehicle->car_type_SUV === 'SUV' ? 'checked' : '' }}> SUV
                                                <!-- <input type="checkbox" name="car_type_SUV" id="SUV" value="SUV" {{ is_array($vehicle->car_type) && in_array('SUV', $vehicle->car_type) ? 'checked' : '' }}> SUV -->
                                            </label>

                                            <label for="Hatchback">
                                                <input type="checkbox" name="car_type_Hatchback" id="Hatchback" value="Hatchback" {{ $vehicle->car_type_Hatchback === 'Hatchback' ? 'checked' : '' }}> Hatchback
                                                <!-- <input type="checkbox" name="car_type_Hatchback" id="Hatchback" value="Hatchback" {{ is_array($vehicle->car_type) && in_array('Hatchback', $vehicle->car_type) ? 'checked' : '' }}> Hatchback -->
                                            </label>

                                            <label for="Luxury">
                                                <input type="checkbox" name="car_type_Luxury" id="Luxury" value="Luxury" {{ $vehicle->car_type_Luxury === 'Luxury' ? 'checked' : '' }}> Luxury
                                                <!-- <input type="checkbox" name="car_type_Luxury" id="Luxury" value="Luxury" {{ is_array($vehicle->car_type) && in_array('Luxury', $vehicle->car_type) ? 'checked' : '' }}> Luxury -->
                                            </label>
                                        @else
                                        <!-- <select class="basic" name="car_type" required>
                                            <option selected disabled>Please Select</option>
                                            ...
                                            <br>
                                            <label for="Economy">
                                                <input type="checkbox" name="car_type_Economy" id="Economy" value="Economy"> Economy
                                            </label>

                                            <label for="SUV">
                                                <input type="checkbox" name="car_type_SUV" id="SUV" value="SUV"> SUV
                                            </label>

                                            <label for="Hatchback">
                                                <input type="checkbox" name="car_type_Hatchback" id="Hatchback" value="Hatchback"> Hatchback
                                            </label>

                                            <label for="Luxury">
                                                <input type="checkbox" name="car_type_Luxury" id="Luxury" value="Luxury"> Luxury
                                            </label>
                                        @endif
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="">Daily Price <span class="text-danger"> * </span></label>
                                        <input type="text" name="price" value="{{ $vehicle->price ?? old('price') ?? null }}"
                                            class="form-control" placeholder="Enter Daily Price..." required>
                                        @if ($errors->has('price'))
                                            <div class="error">{{ $errors->first('price') }}</div>
                                        @endif
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="">Weekly Price <span class="text-danger"> * </span></label>
                                        <input type="text" name="w_price" value="{{ $vehicle->w_price ?? old('w_price') ?? null }}"
                                            class="form-control" placeholder="Enter Weekly Price..." required>
                                        @if ($errors->has('w_price'))
                                            <div class="error">{{ $errors->first('w_price') }}</div>
                                        @endif
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="">Monthly Price <span class="text-danger"> * </span></label>
                                        <input type="text" name="m_price" value="{{ $vehicle->m_price ?? old('m_price') ?? null }}"
                                            class="form-control" placeholder="Enter Monthly Price..." required>
                                        @if ($errors->has('m_price'))
                                            <div class="error">{{ $errors->first('m_price') }}</div>
                                        @endif
                                    </div>
                                </div>
                            </div>
