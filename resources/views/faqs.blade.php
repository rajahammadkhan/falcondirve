    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 sm-padding">
                ...
                <p style="text-align: center;">Feel free to get in contact and we will be happy to answer any questions. For more details contact us on <a href="tel:<?php echo $formattedNumber; ?>" class="custom_achor">{{getSettings('contact_no')}}</a></p>
            </div>
            <!--Sidebar-->
        </div>
    </div>
