        ...
        <div class="row align-items-center">
            ...
            @if(isset($success))
                ...
                <script type="text/javascript">
                    Swal.fire({
                        title: 'Booked!',
                        text: "YOUR REQUEST FOR VEHICLE BOOKING HAS BEEN SUBMITTED SUCCESSFULLY!",
                        icon: 'success',
                        timer: 2000,
                                    ...
                                    <div class="taxi-booking-form">
                                        @if(!empty($data['full_name']))
                                            <div class="features">
                                                ...
                                                <div><span style="font-size: 11px;">{{$data['full_name']}}</span></div>
                                            </div>

                                            <div class="features">
                                                <div style="font-size: 12px;">Email:</div>
                                                <div><span style="font-size: 11px;">{{$data['email']}}</span></div>
                                            </div>

                                            <div class="features">
                                                <div style="font-size: 12px;">Number:</div>
                                                <div><span style="font-size: 11px;">{{$data['number']}}</span></div>
                                            </div>
                                        @else
                                        ...
                                        <div class="features">
                                            ...
                                            <div><span style="font-size: 11px;">{{$data['start_date']}}</span></div>
                                        </div>

                                        <div class="features">
                                            <div style="font-size: 12px;">End Date:</div>
                                            <div><span style="font-size: 11px;">{{$data['end_date']}}</span></div>
                                        </div>

                                        <div class="features">
                                            <div style="font-size: 12px;">Start Time:</div>
                                            <div><span style="font-size: 11px;">{{date('h:i A',strtotime($data['start_time']))}}</span></div>
                                        </div>

                                        <div class="features">
                                            <div style="font-size: 12px;">Start Time:</div>
                                            <div><span style="font-size: 11px;">{{date('h:i A',strtotime($data['end_time']))}}</span></div>
                                        </div>

                                        <div class="features">
                                            <div style="font-size: 12px;">Days:</div>
                                            <div><span style="font-size: 11px;">{{$data['noOfDays']}}</span></div>
                                        </div>

                                        <div class="features">
                                            <div style="font-size: 12px;">Total Amount:</div>
                                            <div><span style="font-size: 11px;">AED {{number_format($data['total_amount'])}}</span></div>
                                        </div><!-- 
