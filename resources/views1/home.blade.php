        ...
        <div class="main-slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="slider-img"><img src="{{url('')}}/assets/img/slider-bg.jpg" alt="img" class="kenburns"
                            style="animation-duration: 12000ms; "></div>
                    <div class="car-holder">
                        <img src="{{url('')}}/assets/img/car-1.png" alt="car" data-animation="car-animation" data-duration="1.5s">
                        <div class="shape">
                            ...
                            <div class="slider-content">
                                ...
                                @csrf
                                            ...
                                            <div data-animation="fade-in-bottom" data-delay="0.5s">
                                                <div class="booking-form">
                                                    <div class="form-field">
                                                        ...
                                                        <input type="text" id="ride-date" name="start_date" class="form-control date-picker" placeholder="Start Date" required>
                                                    </div>
                                                    
                                                    <div class="form-field">
                                                        <i class="las la-calendar"></i>
                                                        <input type="text" id="ride-date" name="end_date" class="form-control date-picker" placeholder="End Date" required>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="slider-btn">
                                        <input type="submit" class="default-btn" data-animation="fade-in-bottom" data-delay="0.9s" value="Search Now">
                                    </div>
                                </form>                                
                            </div>
                        </div>
...
<section class="download-section bd-bottom padding">
                    ...
                    <div class="feature-wrap">
                        ...
                        <ul class="ridek-features">
                            ...
                            <li class="wow fade-in-right" data-wow-delay="500ms">
                                <div class="feature-content">
                                    <a href="{{route('about-us')}}" class="default-btn" id="btn-raed" data-animation="fade-in-bottom"
    ...
    <!--/.blog-section-->
    <section class="blog-section bg-grey padding" style="margin-top: -100px;">
        <div class="container">
            <div class="section-heading text-center mb-40 wow fade-in-bottom" data-wow-delay="200ms">
